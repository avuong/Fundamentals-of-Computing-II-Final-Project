	...
	: Enemy(xf, yf, num_map, 2)
{
	...
	if (Enemy::Enemy::mapPtr->get_BrickLocation(Enemy::enemy_xcoord,Enemy::enemy_ycoord + Goomba_HEIGHT) == 0 || !Enemy::render_right) {
...
bool Goomba::check_up(int mario_xcoord, int mario_ycoord) 
{
